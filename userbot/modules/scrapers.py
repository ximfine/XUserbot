...
@bot.on(xubot_cmd(outgoing=True, pattern="crblang (.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern="carbon"))
...
@bot.on(xubot_cmd(outgoing=True, pattern="img (.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern="currency (.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"google (.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"wiki (.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern="ud (.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"tts(?: |$)([\s\S]*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern="tr(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    ...
    if event.reply_to_msg_id:
        ...
        await event.edit(f"`{xcm}tr LanguageCode` as reply to a message")
        return
...
@bot.on(xubot_cmd(pattern="lang (tr|tts) (.*)", outgoing=True))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"yt (\d*) *(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"rip(audio|video) (.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern="rbg(?: |$)(.*)"))
async def kbg(remob):
...
@bot.on(xubot_cmd(pattern=r"ocr (.*)", outgoing=True))
async def ocr(event):
...
@bot.on(xubot_cmd(pattern=r"decode$", outgoing=True))
...
@bot.on(xubot_cmd(pattern=r"barcode(?: |$)([\s\S]*)", outgoing=True))
async def bq(event):
...
@bot.on(xubot_cmd(pattern=r"makeqr(?: |$)([\s\S]*)", outgoing=True))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"direct(?: |$)([\s\S]*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"paste(?: |$)([\s\S]*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"getpaste(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"neko(?: |$)([\s\S]*)"))
...
@bot.on(xubot_cmd(pattern="ss (.*)", outgoing=True))
