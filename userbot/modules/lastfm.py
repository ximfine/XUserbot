...
@bot.on(xubot_cmd(outgoing=True, pattern=r"lastfm$"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"lastbio (on|off)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"lastlog (on|off)"))
...
CMD_HELP.update({"lastfm": f">`{xcm}lastfm`"
