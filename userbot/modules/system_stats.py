...
@bot.on(xubot_cmd(outgoing=True, pattern=r"spc"))
async def psu(event):
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"sysd$"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"botver$"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"pip(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"aliveu"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"resetalive$"))
