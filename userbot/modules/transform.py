...
@bot.on(xubot_cmd(outgoing=True, pattern=r"(ascii|asciis)$"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"asciibg(?: |$)(.*)"))
async def _(event):
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"(mirror|flip|ghost|bw|poster)$"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"rotate(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern="wast$"))
async def hmm(event):
    if not event.reply_to_msg_id:
        await event.edit("`Reply to Any media..`")
        return
    ...
    cv2.imwrite("shivamgtas.jpg", gray)
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"icircle(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"scircle(?: |$)(.*)"))
async def shiv(event):
    if not event.reply_to_msg_id:
        await event.edit("Reply to any media.")
        return
