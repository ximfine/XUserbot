...
@bot.on(xubot_cmd(outgoing=True, pattern=r"anime ?(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"manga ?(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"a(kaizoku|kayo) ?(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"char ?(.*)"))
async def character(event):
    ...
    if search_query:
        ...
        await event.edit(f"Format: `{xcm}char <character name>`")
        return
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"scanime ?(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"smanga ?(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"sanime ?(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"whatanime"))
