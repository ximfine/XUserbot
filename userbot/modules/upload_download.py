...
@bot.on(xubot_cmd(pattern=r"download(?: |$)(.*)", outgoing=True))
...
@bot.on(xubot_cmd(pattern=r"uploadir (.*)", outgoing=True))
...
@bot.on(xubot_cmd(pattern=r"upload (.*)", outgoing=True))
...
@bot.on(xubot_cmd(pattern=r"uploadas(stream|vn|all) (.*)", outgoing=True))
