...
@bot.on(xubot_cmd(outgoing=True, pattern=r"amag(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"ator(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"aurl(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"apause(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"aresume(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"ashow(?: |$)(.*)"))
...
CMD_HELP.update(
    {
        "aria": f">`{xcm}aurl [URL]` (or) >`.amag [Magnet Link]` (or) >`.ator [path to torrent file]`"
        "\nUsage: Downloads the file into your userbot server storage."
        f"\n\n>`{xcm}apause (or) .aresume`"
