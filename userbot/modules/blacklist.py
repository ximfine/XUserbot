...
@bot.on(xubot_cmd(outgoing=True, pattern=r"addbl(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"listbl(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"rmbl(?: |$)(.*)"))
...
CMD_HELP.update({"blacklist": f">`{xcm}listbl`"
