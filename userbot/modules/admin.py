...
@bot.on(xubot_cmd(outgoing=True, pattern=r"setgpic$"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"promote(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"demote(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"ban(?: |$)(.*)"))
async def ban(bon):
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"unban(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"mute(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"unmute(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"ungmute(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"gmute(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"zombies(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"admins$"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"pin(?: |$)(.*)"))
async def pin(msg):
    # Admin or creator check
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"kick(?: |$)(.*)"))
async def kick(usr):
    # Admin or creator check
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"users ?(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"usersdel ?(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"bots$"))
...
CMD_HELP.update(
    {
        "admin": f">`{xcm}promote <username/reply> <custom rank (optional)>`"
        "\nUsage: Provides admin rights to the person in the chat."
        f"\n\n>`{xcm}demote <username/reply>`"
        "\nUsage: Revokes the person's admin permissions in the chat."
        f"\n\n>`{xcm}ban <username/reply> <reason (optional)>`"
        "\nUsage: Bans the person off your chat."
        f"\n\n>`{xcm}unban <username/reply>`"
        "\nUsage: Removes the ban from the person in the chat."
        f"\n\n>`{xcm}mute <username/reply> <reason (optional)>`"
        "\nUsage: Mutes the person in the chat, works on admins too."
        f"\n\n>`{xcm}unmute <username/reply>`"
        "\nUsage: Removes the person from the muted list."
        f"\n\n>`{xcm}gmute <username/reply> <reason (optional)>`"
        "\nUsage: Mutes the person in all groups you have in common with them."
        f"\n\n>`{xcm}ungmute <username/reply>`"
        ...
        f"\n\n>`{xcm}users` or >`{xcm}users <name of member>`"
        "\nUsage: Retrieves all (or queried) users in the chat."
        f"\n\n>`{xcm}setgpic <reply to image>`"
