...
@bot.on(xubot_cmd(outgoing=True, pattern=r"compress(?: |$)(.*)"))
async def _(event):
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"addzip(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"upzip(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"rmzip(?: |$)(.*)"))
...
CMD_HELP.update({
    "zipfile":
        f"`{xcm}compress` **[optional: <reply to file>]**\
            \nUsage: make files to zip.\
            \n`{xcm}addzip` **<reply to file>**\
            \nUsage: add files to zip list.\
            \n`{xcm}upzip` **[optional: <zip title>]**\
            \nUsage: upload zip list.\
            \n`{xcm}rmzip` **[optional: <zip title>]**\
