...
@bot.on(xubot_cmd(outgoing=True, pattern="notes$"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"clear (\w*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"save (\w*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern="rmbotnotes (.*)"))
...
\n\n`{xcm}save` <notename> <notedata> or reply to a message with .save <notename>\
