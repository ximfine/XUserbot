...
@bot.on(xubot_cmd(outgoing=True, pattern=r"magisk$"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"pixeldl(?: |$)(.*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(xubot_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
...
CMD_HELP.update(
    {
        "android": f">`{xcm}magisk`"
        "\nGet latest Magisk releases"
        f"\n\n>`{xcm}device <codename>`"
        "\nUsage: Get info about android device codename or model."
        f"\n\n>`{xcm}codename <brand> <device>`"
        "\nUsage: Search for android device codename."
        f"\n\n>`{xcm}pixeldl` **<download.pixelexperience.org>**"
        "\nUsage: Download pixel experience ROM into your userbot server."
        f"\n\n>`{xcm}specs <brand> <device>`"
