...
@bot.on(xubot_cmd(outgoing=True, pattern="speed$"))
...
@bot.on(xubot_cmd(outgoing=True, pattern="ping$"))
...
@bot.on(xubot_cmd(outgoing=True, pattern="pong$"))
async def pingme(pong):
    """ For .ping command, ping the userbot from any chat.  """
    start = datetime.now()
...
@bot.on(xubot_cmd(outgoing=True, pattern="pink$"))
async def pingme(pong):
    """ For .ping command, ping the userbot from any chat.  """
    start = datetime.now()
